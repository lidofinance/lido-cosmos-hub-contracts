...
pub struct MsgTokenizeShares {
    ...
    pub amount: ::protobuf::SingularPtrField<Coin>,
    pub tokenized_share_owner: ::std::string::String,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a MsgTokenizeShares {
    fn default() -> &'a MsgTokenizeShares {
        <MsgTokenizeShares as ::protobuf::Message>::default_instance()
    }
}

impl MsgTokenizeShares {
    pub fn new() -> MsgTokenizeShares {
        ::std::default::Default::default()
    }
    ...
    pub fn get_tokenized_share_owner(&self) -> &str {
        &self.tokenized_share_owner
    }
    pub fn clear_tokenized_share_owner(&mut self) {
        self.tokenized_share_owner.clear();
    }

    // Param is passed by value, moved
    pub fn set_tokenized_share_owner(&mut self, v: ::std::string::String) {
        self.tokenized_share_owner = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_tokenized_share_owner(&mut self) -> &mut ::std::string::String {
        &mut self.tokenized_share_owner
    }

    // Take field
    pub fn take_tokenized_share_owner(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.tokenized_share_owner, ::std::string::String::new())
    }
}

impl ::protobuf::Message for MsgTokenizeShares {
    fn is_initialized(&self) -> bool {
        for v in &self.amount {
            if !v.is_initialized() {
                return false;
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.tokenized_share_owner)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.tokenized_share_owner.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.tokenized_share_owner);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.tokenized_share_owner.is_empty() {
            os.write_string(4, &self.tokenized_share_owner)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn new() -> MsgTokenizeShares {
        MsgTokenizeShares::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "delegator_address",
                |m: &MsgTokenizeShares| { &m.delegator_address },
                |m: &mut MsgTokenizeShares| { &mut m.delegator_address },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "validator_address",
                |m: &MsgTokenizeShares| { &m.validator_address },
                |m: &mut MsgTokenizeShares| { &mut m.validator_address },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Coin>>(
                "amount",
                |m: &MsgTokenizeShares| { &m.amount },
                |m: &mut MsgTokenizeShares| { &mut m.amount },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "tokenized_share_owner",
                |m: &MsgTokenizeShares| { &m.tokenized_share_owner },
                |m: &mut MsgTokenizeShares| { &mut m.tokenized_share_owner },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<MsgTokenizeShares>(
                "MsgTokenizeShares",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static MsgTokenizeShares {
        static instance: ::protobuf::rt::LazyV2<MsgTokenizeShares> = ::protobuf::rt::LazyV2::INIT;
        instance.get(MsgTokenizeShares::new)
    }
}

impl ::protobuf::Clear for MsgTokenizeShares {
    fn clear(&mut self) {
        self.delegator_address.clear();
        self.validator_address.clear();
        self.amount.clear();
...
impl ::std::fmt::Debug for MsgTokenizeShares {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MsgTokenizeShares {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a MsgTokenizeSharesResponse {
    fn default() -> &'a MsgTokenizeSharesResponse {
        <MsgTokenizeSharesResponse as ::protobuf::Message>::default_instance()
    }
}

impl MsgTokenizeSharesResponse {
    pub fn new() -> MsgTokenizeSharesResponse {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for MsgTokenizeSharesResponse {
    fn is_initialized(&self) -> bool {
        for v in &self.amount {
            if !v.is_initialized() {
                return false;
    ...
    fn new() -> MsgTokenizeSharesResponse {
        MsgTokenizeSharesResponse::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<Coin>>(
                "amount",
                |m: &MsgTokenizeSharesResponse| { &m.amount },
                |m: &mut MsgTokenizeSharesResponse| { &mut m.amount },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<MsgTokenizeSharesResponse>(
    ...
    fn default_instance() -> &'static MsgTokenizeSharesResponse {
        static instance: ::protobuf::rt::LazyV2<MsgTokenizeSharesResponse> = ::protobuf::rt::LazyV2::INIT;
        instance.get(MsgTokenizeSharesResponse::new)
    }
}

impl ::protobuf::Clear for MsgTokenizeSharesResponse {
    fn clear(&mut self) {
        self.amount.clear();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for MsgTokenizeSharesResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MsgTokenizeSharesResponse {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
